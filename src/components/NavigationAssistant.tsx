...
import type { CoffeeShop, NavigationRoute, NavigationStep } from '@types';
...
function getManeuverIcon(maneuver: string): keyof typeof Feather.glyphMap {
    ...
    <View style={styles.container} pointerEvents="box-none">
      ...
      <View style={styles.bottomBar}>
        ...
        <View style={styles.modeToggleGroup}>
          <TouchableOpacity
            style={[styles.modePill, navigationMode === 'walking' && styles.modePillActive]}
            onPress={() => {
              hapticSelection();
          ...
          >
            <Feather
              name="navigation"
              size={13}
              color={navigationMode === 'walking' ? '#FFFFFF' : COLORS.textSecondary}
            />
            <Text style={[styles.modePillText, navigationMode === 'walking' && styles.modePillTextActive]}>
              Walk
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.modePill, navigationMode === 'driving' && styles.modePillActive]}
            onPress={() => {
              hapticSelection();
          ...
          >
            <Feather
              name="compass"
              size={13}
              color={navigationMode === 'driving' ? '#FFFFFF' : COLORS.textSecondary}
            />
            <Text style={[styles.modePillText, navigationMode === 'driving' && styles.modePillTextActive]}>
              Drive
            </Text>
          </TouchableOpacity>
        </View>

        {/* Right: Actions (Steps List + Recenter + End) */}
          ...
          <View style={styles.modalSheet}>
            ...
            <FlatList
              ...
              renderItem={({ item, index }) => {
                ...
                const mIcon = getManeuverIcon(item.maneuver);
                return (
                  <TouchableOpacity
